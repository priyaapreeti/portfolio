...
const About = () => {
  return (
    <div className="w-11/12 max-w-3xl border  mx-auto" id="about">
      ...
      <div>
        ...
        {/* </div>  */}
        <div className="text-center border mx-auto text-center">
          ...
          <ul className=" grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl items-center">
            {infoList.map(({ icon, iconDark, title, description }, idx) => (
              <li key={idx} className="border border-gray-400 rounded flex flex-col items-center p-3 cursor-pointer">
